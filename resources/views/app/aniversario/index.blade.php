            ...
            <div class="content_login">
                <form class="form-login" action="{{ route('aniversario.store') }}" method="post"
                    ...
                    <div class="content_titulo_login" style="text-align: center;">
                        <img src="{{ asset('app/img/logojacblack.png') }}" alt="Logo JAC"><br><br>
                    ...
                    <div class="form-group col-12">
                        ...
                        <select id="celula_id" name="celula_id" class="form-control-m form-control-lg" style="background:white !important;height: 3.573667rem;" required>
