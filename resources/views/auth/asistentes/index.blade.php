            ...
            <form class="col-lg-12 col-md-12" action="{{ route('auth.asistentes.store') }}" method="post"
                ...
                <div style="display: flex; flex-wrap: wrap;">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input autocomplete="off" type="tel" class="form-control form-control-lg" min="6" id="tel"
                            name="tel" placeholder="Ingrese número de teléfono"
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input form-control-lg" id="foto" name="foto"
            ...
            <div class="col-md-12">
                <div class="col-lg-12">
                    <div class="alert alert-success" role="alert">
                        ...
                        <strong>¡Atención!</strong> Los participantes con una fila de color amarillo han alcanzado la
                        mayoría de edad.
                    </div>
                </div>
