        ...
        <div class="content-header">
            <div class="form-row">
                ...
                <div class="form-group col-lg-4 col-md-6">
                    <label for="fecha_exacta" class="m-0 label-primary">Fecha Exacta de Programa</label> <br>
                    <input type="date" class="form-control-m form-control-lg" id="fecha_exacta" style="background:white!important;">
                </div>

                <!-- Filtro Estado de Asistencia -->
                <div class="form-group col-lg-4 col-md-6">
                    <label for="estado_asistencia" class="m-0 label-primary">Estado de Asistencia</label>
                    <select name="estado_asistencia" id="estado_asistencia" class="form-control-m form-control-lg" style="background:white!important;">
                ...
                <div class="form-group col-lg-4 col-md-6">
                    ...
                    <select name="celula_filter_id" id="celula_filter_id" class="form-control-m form-control-lg" style="background:white!important;">
                        <option value="" selected>-- Seleccione --</option>
