            ...
            <div class="container-fluid">
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-lg-4">
                        ...
                        <input type="date" id="fecha_desde" class="form-control form-control-lg" style="background:white !important;"/>
                    </div>
                    
                    <div class="form-group col-12 col-lg-4">
                        <label>Fecha Hasta:</label>
                        <input type="date" id="fecha_hasta" class="form-control form-control-lg" style="background:white !important;"/>
                    </div>
            
                    <!-- Botón de Consulta -->
                    <div class="form-group col-12 col-lg-4 d-flex flex-column">
                        <label>&nbsp;</label>
                        <a href="javascript:void(0)" id="btn-consultar" class="btn btn-primary btn-lg">
